...
const infoJsonPath = path.join(__dirname, '../public/data/1841740/info.json');

describe('Verificación del archivo info.json en la carpeta 1841740', () => {
...
describe('Validación de la estructura de info.json en la carpeta 1841740 - Estudiante: Brandon Perdomo', () => {
