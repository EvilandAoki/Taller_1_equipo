...
const infoJsonPath = path.join(__dirname, '../public/data/2042419/info.json');

describe('Verificación del archivo info.json en la carpeta 2310117', () => {
...
describe('Validación de la estructura de info.json en la carpeta 2042419 - Estudiante: Alejandro Villamil', () => {
