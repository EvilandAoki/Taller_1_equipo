...
const infoJsonPath = path.join(__dirname, '../public/data/2042400/info.json');

describe('Verificación del archivo info.json en la carpeta 204200', () => {
...
describe('Validación de la estructura de info.json en la carpeta 2042400 - Estudiante: Alexandra Lerma', () => {
